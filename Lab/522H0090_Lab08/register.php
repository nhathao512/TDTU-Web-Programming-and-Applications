...
if ($stmt->execute()) {
    $activation_link = 'http://localhost:8082/activate.php?email=' . urlencode($email) . '&activate_token=' . urlencode($activate_token);
    $body = "Click to activate your account: <a href='" . $activation_link . "'>Activate</a>";
                ...
                <form method="post" action="activate.php" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" id="togglePass2Visibility" onclick="togglePasswordVisibility('pass2')">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
